# xuanhuan-xiuxian 题材资产包

## 定位

这是当前玄幻 / 修仙题材的资产入口页。默认先看这里和 `docs/assets/xuanhuan-xiuxian-reference-map.md`，再决定是否继续下钻子风格与通用资料。

## 建议用途

- 开书时补题材基线
- 定调时选择子风格路径
- 写作中遇到升级、战斗、宗门、地图问题时按需补读
...
- `assets/genres/01a-xuanhuan-fanrenliu.md`
- `assets/genres/01b-xuanhuan-wenjianliu.md`
